...
public class UserNotifySseDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public UserNotifySseDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
