...
public class UserNotifySignalRDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public UserNotifySignalRDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
